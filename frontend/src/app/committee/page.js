            ...
            <div className="max-w-6xl mx-auto px-6 mt-16 space-y-24 relative">
                ...
                {isLoadingCore ? (
                    ...
                    <>
                        ...
                        {(coreCommittee.pastPresident?.length > 0 || coreCommittee.pastVicePresident?.length > 0 || coreCommittee.pastSecretary?.length > 0 || coreCommittee.pastTreasurer?.length > 0 || coreCommittee.pastMembers?.length > 0) && (
                                ...
                                <div className="max-w-5xl mx-auto">
                                    ...
                                    <div className="space-y-16">
                                        {[
                                            ...
                                            { key: "pastSecretary", role: { en: "Former Secretary", mr: "माजी सचिव" } },
                                            { key: "pastTreasurer", role: { en: "Former Treasurer", mr: "माजी खजिनदार" } },
                                            { key: "pastMembers", role: { en: "Former Member", mr: "माजी सदस्य" } }
                                        ].map(group => {
                                        ...
                                        <div className="space-y-3">
                                            {sub.members && sub.members.length > 0 ? (
                                                sub.members.map((member, j) => (
                                                    <div key={j} className={`text-center text-gray-800 font-medium py-1 ${lang === 'mr' ? 'text-lg' : 'text-base'}`}>
                                                        <span className="inline-flex items-center gap-2 justify-center">
                                                            {member.name[lang]}
                                                            {member.role?.[lang] && (
                                                                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#8b0000] text-white uppercase tracking-wide whitespace-nowrap">
                                                                    {member.role[lang]}
                                                                </span>
                                                            )}
                                                        </span>
