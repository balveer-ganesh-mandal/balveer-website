...
export default function Home() {
  ...
  const content = {
    ...
    mr: {
      ...
      historyText1:
        "बालवीर गणेश मंडळ (चंडीचा पावन गणपती) हे गाढ मैत्रीतून जन्मले — कै. श्री. निंबादास पिंपरकर, श्री. राजाभाऊ डवले, श्री. हांडे आणि इतर मित्रांनी त्यांच्या शालेय जीवनातच या मंडळाची स्थापना केली. तरुण वयातील या उपक्रमाने लवकरच मलकापूरच्या सर्वात जपलेल्या परंपरांपैकी एक रूप धारण केले.",
      historyText2:
